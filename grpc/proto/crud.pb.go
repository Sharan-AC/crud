...
var file_crud_proto_rawDesc = []byte{
	...
	,
...
var file_crud_proto_depIdxs = []int32{
	0, // 0: proto.CRUD.CreateItem:input_type -> proto.Employee
	1, // 1: proto.CRUD.CreateItem:output_type -> proto.ID
...
func (c *cRUDClient) CreateItem(ctx context.Context, in *Employee, opts ...grpc.CallOption) (*ID, error) {
	out := new(ID)
	err := c.cc.Invoke(ctx, "/proto.CRUD/CreateItem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CRUD_CreateItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CRUD/CreateItem",
	}
